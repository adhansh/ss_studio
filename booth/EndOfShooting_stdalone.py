...
def MoveFile_stdalone():
    ...
    destPath = rootPath + targetFolder
...
btn_eos = Button(root, padx = 2, pady = 2, text = '촬영 사진 저장', font=('Helvetica', 20),  width=14, background='cyan', command = MoveFile_stdalone)
...
btn_back = Button(root, padx = 2, pady = 2, text = '사진삭제', font=('Helvetica', 20), width=14, background='red', command = ClearPics)
